 ...
 * @author Eduardo
 */
public class CarroPesquisa extends javax.swing.JInternalFrame {

    JDesktopPane pnlPrincipal;
    
    /**
     * Creates new form CarroPesquisa
     */
    public CarroPesquisa() {
        initComponents();
        try {
            carregarTabela(new ECarro());
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e.getMessage());
        }
    }
    
    CarroPesquisa(JDesktopPane desktopPene) {
        this();
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(txtParametro, javax.swing.GroupLayout.PREFERRED_SIZE, 133, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tblResultadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblResultadoMousePressed
        ...
        try {
            ...
            CarroCadastro tela = new CarroCadastro(codigo);
    ...
    private void carregarTabela(ECarro parametro) throws SQLException {
    ...
    private void pesquisar() {
        try {
            ...
            ECarro parametro = new ECarro();

            if (txtParametro.getText().isEmpty()) {
                parametro.setNome_modelo(txtParametro.getText());
            }
